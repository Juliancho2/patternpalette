  ...
  return (
    <nav className='flex items-center gap-2'>
      <li className='list-none w-12'>
        <Anchor href={'https://twitter.com/julianchoms'} styles='flex items-center justify-center gap-1  text-xs py-1 px-2 rounded-md text-slate-300  hover:scale-105 transition-all  hover:bg-gray-200

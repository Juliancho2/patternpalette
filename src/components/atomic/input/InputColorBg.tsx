...
const InputColorBg = () => {
  ...
  return (
    <div >
      <label className="text-slate-400 font-medium text-sm">Background</label>
      <div className='flex flex-col rounded-full relative'>
        <div onClick={() => context?.handlePickerBg()} style={{ background: `${context?.bgBody.backgroundColor}` }} className='h-8 w-8 rounded-full border cursor-pointer'>
